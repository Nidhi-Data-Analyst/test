function generateSignature() {
    ...
    reader.onloadend = function () {
        ...
        <div class="signature-container" style="font-family: Poppins, Arial, sans-serif; line-height: 1.5; color: #a6a6a6; display: Block; align-items: flex-start; border: 1px solid #e0e0e0; padding: 2px; border-radius: 5px; margin-left: 5px; 
            ...
            <div class="signature-details" style="display: Block; flex-direction: column;">
                <div class="name-linkedin" style="display: Block; align-items: center;">
                ...
                <div class="contact-info" style="margin-top: 10px; display: Block; flex-direction: column; font-size: 10px;">
                ...
                <div class="social-icons" style="margin-top: 3px; display: Block;">
