            ...
            <table>
                <tr>
                    <td style="vertical-align: top; padding-right: 10px;">
                        ...
                        <img src="${githubBaseUrl}school-logo.png?raw=true" alt="School Logo" class="school-logo"style="width:100%; max-width:70px; display:block; margin-top: 3px; margin-left: auto; margin-rigth: auto;">
