            ...
            <table>
                <tr>
                    <td style="vertical-align: top; padding-right: 10px;">
                        ...
                        <img src="${githubBaseUrl}school-logo.png?raw=true" alt="School Logo" class="school-logo" style=style="width:100%; max-width:60px; display:block; text-align:center;  margin-top: 3px;">
